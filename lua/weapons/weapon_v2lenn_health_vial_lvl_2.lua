-- "lua\\weapons\\weapon_v2lenn_health_vial_lvl_2.lua"
...
SWEP.Contact        = ""
SWEP.Purpose        = "Some health vial that gives you only 8 hp, max = 35 and has a slow delay (8 seconds)"
...
function SWEP:Initialize()
     self:SetColor(Color(122, 106, 0, 255)) -- Paints world model
end
...
---------------------------------------------------------*/
  function SWEP:PrimaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hp >= 35 ) then return; end
                if( hp <= 35 ) then hp = hp + 8 end
  ...
  function SWEP:SecondaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hpp >= 35 ) then return; end
                if( hpp <= 35 ) then hpp = hpp + 8 end
