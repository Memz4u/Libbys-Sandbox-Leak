-- "lua\\weapons\\weapon_v4lenn_ar2rifle_ammo.lua"
...
SWEP.ViewModel			= "models/Items/combine_rifle_cartridge01.mdl"
...
if ( !self:CanPrimaryAttack() ) then return end 
	...
	local ent = ents.Create( "item_ammo_ar2_large" )
