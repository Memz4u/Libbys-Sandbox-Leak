-- "lua\\weapons\\weapon_v4lenn_tommy_gun.lua"
...
SWEP.Purpose                = "Also, another weapon that shouldn't really be in the machine gun section but had to be classified as a submachine weapon."
...
SWEP.Primary.Sound = "weapons/smg1/smg1_fireburst1.wav" // Weapon sound effect. i choosed the awp one but it requires CSS
...
SWEP.Primary.ClipSize = 60 // The clipsize
SWEP.Primary.Ammo = "smg1" // ammmo type pistol/ smg1 or ar2
SWEP.Primary.DefaultClip = 170 // How much ammo the weapon gives in total. / NERFED /
SWEP.Primary.Spread = 0.20// The bullet spread. 0.01 = nospread, anything over 1 would be very terrible spread / NERFED /
...
SWEP.Primary.Recoil = 0.30  // How much we should punch the view. higher recoil makes it terribly bad when you wanna shoot it / INCREASED /
SWEP.Primary.Delay = 0.12  // Delay. or how much milliseconds it takes to shoot another bullet after the other bullet was shot. / INCREASED /
...
function SWEP:ShootBullet( dmg, recoil, numbul, cone )
   ...
   if ((game.SinglePlayer() and SERVER) or
      ...
      recoil = sights and (recoil * 5) or recoil
