-- "lua\\weapons\\weapon_v4lenn_ar2orbalt_ammo.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "AR2 Alt / Orb Ammo"			
...
SWEP.Primary.Ammo = "AR2AltFire" // ammmo type pistol/ smg1 
...
if ( !self:CanPrimaryAttack() ) then return end 
	...
	local ent = ents.Create( "item_ammo_ar2_altfire" )
