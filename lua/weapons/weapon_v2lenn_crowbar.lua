-- "lua\\weapons\\weapon_v2lenn_crowbar.lua"
...
if (CLIENT) then --the cl_init.lua stuff goes in here
   ...
   SWEP.PrintName = "IS IT REALLY A WHIFFER SNIFFER";
   SWEP.Slot = 0;
   SWEP.SlotPos = 1;
   SWEP.DrawAmmo = false;
...
SWEP.Secondary.Sound = Sound ("npc/sniper/echo1.wav")
...
function SWEP:Initialize()
	...
	weight = 400
                  ...
                  killicon.Add( "green", "prop_physics", Color( 0, 255, 0, 255 ) )
