-- "lua\\weapons\\weapon_v4lenn_shotgun_ammo.lua"
...
SWEP.ViewModel			= "models/Items/BoxBuckshot.mdl"
SWEP.WorldModel			= "models/Items/BoxBuckshot.mdl"
...
if ( !self:CanPrimaryAttack() ) then return end 
	...
	local ent = ents.Create( "item_box_buckshot" )
