-- "lua\\weapons\\weapon_v7lenn_whippingcrowbar.lua"
...
if ( CLIENT ) then
	SWEP.PrintName = "Gigantic Whipper Crowbar"
	SWEP.Author = "Lenn's Weapons"
	SWEP.Purpose = "a weapon used to tolerate disclipine."
	SWEP.Instructions = "Hold the mouse button i bet ur going to run away if u see a man with this weapon"
	SWEP.Slot = 0
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false					 
