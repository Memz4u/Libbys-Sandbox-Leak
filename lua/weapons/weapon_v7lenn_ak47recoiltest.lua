-- "lua\\weapons\\weapon_v7lenn_ak47recoiltest.lua"
...
if ( SERVER ) then
	...
	SWEP.HoldType			= "ar2" -- You can set it using smg, ar2, pistol, 357, or find a list of holdtypes, holdtypes are to see how the player is holding the weapon properly.
	
end

if ( CLIENT ) then

	SWEP.PrintName			= "AK47 recoil test" -- We need to insert a name for this weapon.			
	SWEP.Author			= "Created by Lenn" -- Author of the weapon.
...
SWEP.Purpose                = "Broom broom! broom! Automatic weapon. does a decent amount of damage. People who like the ak47 is the people who are real OG gangsters. for short, we call them. Original gangsters! and also russians use it (BUFFED VERSION): Spread is lower."
...
SWEP.Primary.DefaultClip = 150 // How much ammo the weapon gives in total. / NERFED /
SWEP.Primary.Spread = 0.22 // The bullet spread. 0.01 = nospread, anything over 1 would be very terrible spread / NERFED /
...
SWEP.Primary.Force = 30 // The force of the shot, How strong it can blast objects, high force would be incredibly tough / NERFED /
SWEP.Primary.Cone = 1 
...
-- This is basically some crosshair
