-- "lua\\weapons\\weapon_v2lenn_health_vial_lvl_1.lua"
...
SWEP.Contact        = ""
SWEP.Purpose        = "Some health vial that gives you only 5 hp, max = 20 and has a slow delay (10 seconds)"
...
function SWEP:Initialize()
     self:SetColor(Color(127, 95, 0, 255)) -- Paints world model
end
...
---------------------------------------------------------*/
  ...
  function SWEP:SecondaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hpp >= 20 ) then return; end
                if( hpp <= 20 ) then hpp = hpp + 5 end
