-- "lua\\weapons\\weapon_v2lenn_health_vial_lvl_3.lua"
...
SWEP.Contact        = ""
SWEP.Purpose        = "Some health vial that gives you only 13 hp, max = 50 and has a slow delay (6.5 seconds)"
...
function SWEP:Initialize()
     self:SetColor(Color(120, 156, 0, 255)) -- Paints world model
end
...
---------------------------------------------------------*/
  ...
  function SWEP:SecondaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hpp >= 50 ) then return; end
                if( hpp <= 50 ) then hpp = hpp + 13 end
