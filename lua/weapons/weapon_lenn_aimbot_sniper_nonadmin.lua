-- "lua\\weapons\\weapon_lenn_aimbot_sniper_nonadmin.lua"
...
if (CLIENT) then --the cl_init.lua stuff goes in here
   ...
   SWEP.PrintName = "The Aimbot Sniper";
   SWEP.Slot = 1;
   SWEP.SlotPos = 1;
   SWEP.DrawAmmo = false;
...
SWEP.Author                    = "Lenn"
SWEP.Purpose                = "A IMAGINARY SNIPER THAT SHOOTS DEADLY BOLTS AND HAS AUTO-AIMBOT. THIS ONE IS PRETTY DEADLY BUT HAS A LONG DELAY."
...
SWEP.Primary.Sound = Sound ("weapons/stinger_fire1.wav") -- If someone's got a better idea than this sound I'll try it out.
...
function SWEP:DrawHUD()
    ...
    if self.Aimbot.Target ~= nil then
        local text = "Target Locked On: ("..self:FixName(self.Aimbot.Target)..")"
