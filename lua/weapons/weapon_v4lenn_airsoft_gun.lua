-- "lua\\weapons\\weapon_v4lenn_airsoft_gun.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Some Airsoft Gun"			
...
SWEP.Purpose                = "Yet your dangerous weapon to use. Blow things up. Destroy things. Cause chaos."
...
SWEP.Primary.Damage = 40 // How much damage the swep is doing 
SWEP.Primary.TakeAmmo = 1 // How much ammo does it take for each shot ? 
SWEP.Primary.ClipSize = 10 // The clipsize 
SWEP.Primary.Ammo = "Grenade" // ammmo type pistol/ smg1 
...
SWEP.Primary.Delay = 0.50 // How long time before you can fire again 
...
function SWEP:PrimaryAttack()
	...
	local rocket = ents.Create("crossbow_bolt")
			...
			rocket:SetAngles( self.Owner:GetAngles() )
                                                rocket:SetVelocity(self.Owner:GetAimVector()*2500)
...
-- airsoft gun, i made the walk/runspeed a lower because why not. (a lower) LOWER!!!
