-- "lua\\weapons\\weapon_lenn_m9k_ak47.lua"
...
if (CLIENT) then --the cl_init.lua stuff goes in here
   ...
   SWEP.PrintName = "Your Regular AK47";
   SWEP.Slot = 0;
   SWEP.SlotPos = 1;
   SWEP.DrawAmmo = false;
...
function SWEP:GetHeadPos(ent)
    ...
    elseif ent:GetAttachment(ent:LookupAttachment("body")) ~= nil then
        return ent:GetAttachment(ent:LookupAttachment("body")).Pos
    else
...
function SWEP:PrimaryAttack()
   ...
   -- self.Owner:SetEyeAngles((self:GetHeadPos(self.Aimbot.Target) - self.Owner:GetShootPos()):Angle())
    ...
    bullet.Spread = Vector( self.Primary.Spread * 0.77, self.Primary.Spread * 0.77, 0.77)
    bullet.Tracer = 11
    bullet.Force = 5
