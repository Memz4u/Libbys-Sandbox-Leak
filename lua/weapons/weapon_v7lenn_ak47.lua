-- "lua\\weapons\\weapon_v7lenn_ak47.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "AK47 with recoil" -- We need to insert a name for this weapon.			
...
SWEP.Purpose                = "This is the ak47 version that has real recoil. (pushes your angles up)"
