-- "lua\\weapons\\weapon_v3lenn_terrifying_lightning_fists.lua"
...
SWEP.PrintName = "Terrfiying Lightning fists"
SWEP.Author = "Lenn, Credits too Kilburn, robotboy655, MaxOfS2D & Tenrys"
SWEP.Purpose = "We sure as hell used terrifying lightning fists! I murdered A FUCKTON TON OF ANTLIONS WITH MY VERY FAST BARE HANDS! these are like superhero fists! but i cant hit too hard...."
...
function SWEP:PrimaryAttack( right )
	...
	self:SetNextSecondaryFire( CurTime() + 0.07 )
