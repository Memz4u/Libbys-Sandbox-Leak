-- "lua\\weapons\\tf_weapon_bigearner.lua"
...
list.Add( "OverrideMaterials", "models/player/shared/ice_player" )
 ...
 function SWEP:Precache() 
	...
	util.PrecacheModel("models/weapons/c_models/c_switchblade/c_switchblade.mdl" )
 end 



SWEP.PrintName = "The Big Earner"
...
SWEP.WorldModel        = Model("models/weapons/c_models/c_switchblade/c_switchblade.mdl" )
...
self.Owner:EmitSound("ambient/fire/gascan_ignite1.wav")
self.Owner:EmitSound("player/spy_disguise.wav")
self.Owner:SetWalkSpeed( "600" ) 
self.Owner:SetRunSpeed( "600" )
timer.Simple( 5, function() if not IsValid(self) or not self.Owner:Alive() then return end self.Owner:EmitSound("ambient/fire/mtov_flame2.wav") self.Owner:SetWalkSpeed( "200" ) self.Owner:SetRunSpeed( "400" ) end)
...
if (CLIENT) then
self.CModel = ClientsideModel("models/weapons/c_models/c_switchblade/c_switchblade.mdl")
local vm = self.Owner:GetViewModel()
