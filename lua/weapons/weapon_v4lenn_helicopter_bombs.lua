-- "lua\\weapons\\weapon_v4lenn_helicopter_bombs.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Helicopter Bomb"			
...
SWEP.Purpose                = "This will shoot Helicopter bombs to blow up within 3 or more seconds, and remember, you are not welcome to be near it!"
SWEP.Instructions            = "Press right click to shoot helicopter bombs / mines."


SWEP.ViewModel			= "models/combine_helicopter/helicopter_bomb01.mdl"
