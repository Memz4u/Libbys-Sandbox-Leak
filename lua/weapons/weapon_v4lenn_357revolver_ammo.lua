-- "lua\\weapons\\weapon_v4lenn_357revolver_ammo.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "357 / Revolver Ammo"			
...
SWEP.ViewModel			= "models/Items/357ammo.mdl"
SWEP.WorldModel			= "models/Items/357ammo.mdl"
...
SWEP.Primary.Ammo = "357" // ammmo type pistol/ smg1 
...
if ( !self:CanPrimaryAttack() ) then return end 
	...
	local ent = ents.Create( "item_ammo_357_large" )
