-- "lua\\weapons\\tf_weapon_automaticbackstab.lua"
...
self.Backstab = 1
    ...
    self.Weapon:EmitSound("items/smallmedkit1.wav")
                ...
                if( hpp <= 500 ) then hpp = hpp + 100 end
...
self.Owner:ChatPrint("backstab detected. attacking")
