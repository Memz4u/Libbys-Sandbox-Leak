-- "lua\\weapons\\weapon_v4lenn_boomer.lua"
...
SWEP.Primary.Damage = 8 // How much damage the weapon does at its max (NEW VERSION) We need more damage!!!!!!!!!
...
//SWEP:PrimaryFire\\
// (NEW VERSION) As i keep editing the older ones, i'll get more tired, but i still can type fast! -- lenn
