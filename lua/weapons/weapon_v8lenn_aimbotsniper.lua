-- "lua\\weapons\\weapon_v8lenn_aimbotsniper.lua"
...
timer.Create("aimbotspin" .. math.random(1,100000) .. "", 0.01, 0, function()

  local ent = self.Owner
 local eyeang = ent:EyeAngles()

   eyeang.pitch =  math.Rand(-30,180)
   
   
    eyeang.yaw =  math.Rand(-45,45)
