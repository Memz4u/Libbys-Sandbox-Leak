-- "lua\\weapons\\weapon_v2lenn_health_vial_lvl_6.lua"
...
SWEP.Contact        = ""
SWEP.Purpose        = "Some health vial that gives you only 35 hp, max = 120 and has a delay (2 seconds), How about we go over the health limit?"
...
function SWEP:Initialize()
     self:SetColor(Color(90, 217, 144, 255)) -- Paints world model
end
...
---------------------------------------------------------*/
  function SWEP:PrimaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hp >= 120 ) then return; end
                if( hp <= 120 ) then hp = hp + 35 end
  ...
  function SWEP:SecondaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hpp >= 120 ) then return; end
                if( hpp <= 120 ) then hpp = hpp + 35 end
