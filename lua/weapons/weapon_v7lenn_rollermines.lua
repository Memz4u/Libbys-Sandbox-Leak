-- "lua\\weapons\\weapon_v7lenn_rollermines.lua"
...
SWEP.Purpose                = "Next generation time, instead of flying slayers we decided it was best to make such paranormal things"
SWEP.Instructions            = "Ya shoot the freaken rollermine, dumbass"
...
SWEP.Primary.ClipSize = 5 // The clipsize 
