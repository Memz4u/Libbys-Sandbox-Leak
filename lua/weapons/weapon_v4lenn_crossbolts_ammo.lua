-- "lua\\weapons\\weapon_v4lenn_crossbolts_ammo.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Crossbolts Ammo"			
...
SWEP.ViewModel			= "models/Items/CrossbowRounds.mdl"
...
if ( !self:CanPrimaryAttack() ) then return end 
	...
	local ent = ents.Create( "item_ammo_crossbow" )
