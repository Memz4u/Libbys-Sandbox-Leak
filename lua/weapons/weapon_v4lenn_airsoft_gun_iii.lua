-- "lua\\weapons\\weapon_v4lenn_airsoft_gun_iii.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Some Even Better Airsoft Gun"			
...
SWEP.Primary.DefaultClip = 235 // How much ammo does the swep come with `? 
