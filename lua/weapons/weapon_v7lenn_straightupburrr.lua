-- "lua\\weapons\\weapon_v7lenn_straightupburrr.lua"
...
SWEP.Purpose                = "The gun goes BURRRRRRRRRRRRRR like a minigun lol"
...
SWEP.Primary.Sound = "Weapon_AUG.Single" // Weapon sound effect. i choosed the awp one but it requires CSS
SWEP.Primary.Damage = 6 // How much damage the weapon does at its max / NERFED /
...
SWEP.Primary.DefaultClip = 800 // How much ammo the weapon gives in total. / NERFED /
SWEP.Primary.Spread = 0.12 // The bullet spread. 0.01 = nospread, anything over 1 would be very terrible spread / NERFED /
...
SWEP.Primary.Delay = 0.03 // Delay. or how much milliseconds it takes to shoot another bullet after the other bullet was shot. (NEW VERSION) Decreased delay, because slow delay looked a little crappy
