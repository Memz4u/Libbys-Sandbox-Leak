-- "lua\\weapons\\weapon_lenn_aimbotted_prop.lua"
...
SWEP.Secondary.Sound = Sound ("ambient/energy/newspark03.wav")
...
hook.Add("ShouldDrawLocalProp", "MyHax ShouldDrawLocalProp", function(ply)
if self.On == true then
        return true
    end
end)
