-- "lua\\weapons\\weapon_v2lenn_physics_gun_fridge.lua"
-- Retrieved by https://github.com/c4fe/glua-steal
-- This weapon is used for propkill practices. 



SWEP.PrintName		= "Physics Gun (fridge)"
...
self:TakePrimaryAmmo(self.Primary.TakeAmmo) 
	...
	self:ThrowMelon("models/props_c17/lockers001a.mdl",200000000,"big")
end
...
self.Owner:FireBullets( bullet ) 
self.Weapon:SetNextSecondaryFire( CurTime() + 2.25 )	
local FireTimes = 1
self.Weapon:SendWeaponAnim( ACT_VM_PRIMARYATTACK )
