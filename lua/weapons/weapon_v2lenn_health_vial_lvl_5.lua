-- "lua\\weapons\\weapon_v2lenn_health_vial_lvl_5.lua"
...
SWEP.Contact        = ""
SWEP.Purpose        = "Some health vial that gives you only 25 hp, max = 100 and has a delay (3 seconds), it's like you're regular gordon freeman's health vial by now, (well kinda)"
...
function SWEP:Initialize()
     self:SetColor(Color(90, 217, 0, 255)) -- Paints world model
end
...
---------------------------------------------------------*/
  ...
  function SWEP:SecondaryAttack()
        ...
        if( SERVER ) then 
                ...
                if( hpp <= 100 ) then hpp = hpp + 25 end
