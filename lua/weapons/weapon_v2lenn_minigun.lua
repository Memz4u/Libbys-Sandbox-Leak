-- "lua\\weapons\\weapon_v2lenn_minigun.lua"
...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "A Litteral Minigun"			
...
SWEP.Purpose                = "A minigun, let's say, it's a heavy specified weapon, that sprays too many bullets, and has a shitty spread, yep"
...
SWEP.IronSightsPos = Vector(-6.671, -6.231, 0.839)
SWEP.IronSightsAng = Vector(0, 0, 0)

//General settings\\
 
//PrimaryFire Settings\\ 
SWEP.Primary.Sound = "Weapon_SMG.Single" // Weapon sound effect. i choosed the awp one but it requires CSS
...
SWEP.Primary.DefaultClip = 700 // How much ammo the weapon gives in total. / NERFED /
SWEP.Primary.Spread = 0.7  // The bullet spread. 0.01 = nospread, anything over 1 would be very terrible spread / NERFED /
SWEP.Primary.NumberofShots = 3 // How many bullets you are firing each shot. 
...
SWEP.Primary.Delay = 0.04  // Delay. or how much milliseconds it takes to shoot another bullet after the other bullet was shot. / INCREASED /
...
function SWEP:PrimaryAttack() 
	...
	self:TakePrimaryAmmo(self.Primary.TakeAmmo) 
        self.Owner:ViewPunch( Angle( -0.20, 0, 0 ) )
...
local ground = self.Owner:GetGroundEntity()
		if self.Owner:KeyDown( IN_FORWARD ) and !self.Owner:KeyDown( IN_DUCK ) and (ground:IsWorld() or ground:IsWorld()) then
			...
			self.Primary.Cone = 80
			else
			if self.Owner:KeyDown ( IN_RELOAD) then
			self.Primary.Cone = 25
			else
			self.Primary.Cone = 26
							end
