-- "lua\\weapons\\tf_weapon_cicle_withhelper.lua"
...
SWEP.PrintName = "Cicle with advice"
...
timer.Simple(0.01, function() if( CurTime() < self.NextStrike ) then return; end
 ...
 return; end
                if( hp <= 5 ) then self:MakeIce( tr.Entity ) end
...
self.Owner:ChatPrint("Ready to backstab")
