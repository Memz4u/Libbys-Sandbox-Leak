-- "addons\\toyboxstuff\\lua\\entities\\antirpg.lua"
...
if SERVER then --Do a tick hook so we aim faster
...
function EFFECT:Think()
    if CurTime() > self.Time or not IsValid(self.Anti) or not IsValid(self.RPG) then
        return false
    end
