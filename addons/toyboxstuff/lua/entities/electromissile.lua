-- "addons\\toyboxstuff\\lua\\entities\\electromissile.lua"
...
function ENT:Discharge()
	...
	timer.Simple(0.2, function() if IsValid(self) then self:Discharge() end end)
end
...
function ENT:Initialize()
	...
	timer.Simple(0.4, function() if IsValid(self) then self:Discharge() end end)
	timer.Simple(10, function() if IsValid(self) then self:Explosion() end end)
end
