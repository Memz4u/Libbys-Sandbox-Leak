-- "addons\\toyboxstuff\\lua\\entities\\airstrike.lua"
...
function ENT:SpawnFunction( ply, tr, classname ) --Spawns the entity
...
function ENT:PhysicsCollide( data, physobj )
	...
	util.BlastDamage(self, self or self.Owner, self:GetPos(), 1024, 500) --Blast damage and radius
	self:Remove()
end
