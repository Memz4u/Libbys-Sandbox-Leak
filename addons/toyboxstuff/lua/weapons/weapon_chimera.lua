-- "addons\\toyboxstuff\\lua\\weapons\\weapon_chimera.lua"
...
SWEP.ViewModelBonescales = {["Cylinder"] = Vector(0.01, 0.01, 0.01)}
SWEP.VElements = {
	["barrel"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "Python", pos = Vector(0, 0.2, 1.442), angle = Angle(0, 0, 0), size = Vector(0.041, 0.041, 0.144), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/grey_steel", skin = 0, bodygroup = {} },
	["bullet1"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(0, -0.689, -1.295), angle = Angle(0, 0, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["bullet2"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(0.606, -0.369, -1.295), angle = Angle(0, -120, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["bullet3"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(0.606, 0.368, -1.295), angle = Angle(0, -240, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["bullet4"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(0, 0.688, -1.295), angle = Angle(0, 180, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["bullet5"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(-0.607, 0.368, -1.295), angle = Angle(0, -120, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["bullet6"] = { type = "Model", model = "models/props_phx/smallwheel.mdl", bone = "Cylinder", pos = Vector(-0.607, -0.369, -1.295), angle = Angle(0, -240, 0), size = Vector(0.05, 0.05, 0.699), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["cylinder"] = { type = "Model", model = "models/Mechanics/wheels/wheel_rounded_36.mdl", bone = "Cylinder", pos = Vector(0, 0, -0.187), angle = Angle(0, 0, 0), size = Vector(0.043, 0.043, 0.059), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/grey_steel", skin = 0, bodygroup = {} },
	["cylinderback1"] = { type = "Model", model = "models/Mechanics/wheels/wheel_speed_72.mdl", bone = "Cylinder", pos = Vector(0, 0, -1.407), angle = Angle(0, 0, 0), size = Vector(0.028, 0.028, 0.009), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
	["cylinderback2"] = { type = "Model", model = "models/Mechanics/wheels/wheel_speed_72.mdl", bone = "Cylinder", pos = Vector(0, 0, -1.42), angle = Angle(0, 180, 0), size = Vector(0.021, 0.021, 0.019), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["cylinderfront"] = { type = "Model", model = "models/Mechanics/wheels/wheel_speed_72.mdl", bone = "Cylinder", pos = Vector(0, 0, 1.001), angle = Angle(0, 0, 0), size = Vector(0.03, 0.03, 0.03), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
	["sight1"] = { type = "Model", model = "models/props_junk/iBeam01a.mdl", bone = "Python", pos = Vector(0, -1.706, 3.099), angle = Angle(90, 0, 0), size = Vector(0.045, 0.045, 0.039), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/grey_steel", skin = 0, bodygroup = {} },
	["sight2"] = { type = "Model", model = "models/props_junk/iBeam01a.mdl", bone = "Python", pos = Vector(0, -1.287, 3.099), angle = Angle(90, 0, 0), size = Vector(0.045, 0.045, 0.05), color = Color(255, 100, 50, 255), surpresslightning = false, material = "phoenix_storms/Indenttiles_1-2", skin = 0, bodygroup = {} },
	["light"] = { type = "Sprite", sprite = "particle/Particle_Glow_04", bone = "Cylinder", pos = Vector(0, 0.2, 0.6), size = { x = 4, y = 4 }, color = Color(255, 160, 0, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false}
}
SWEP.WElements = {
	["barrel"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", pos = Vector(8.829, 0.981, -3.664), angle = Angle(-90, 0.287, 0), size = Vector(0.039, 0.039, 0.144), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/grey_steel", skin = 0, bodygroup = {} },
	["sight"] = { type = "Model", model = "models/props_junk/iBeam01a.mdl", pos = Vector(10.319, 0.856, -5.375), angle = Angle(0, 0.361, 90), size = Vector(0.048, 0.028, 0.035), color = Color(100, 90, 90, 255), surpresslightning = false, material = "phoenix_storms/grey_steel", skin = 0, bodygroup = {} },
	["light"] = { type = "Sprite", sprite = "particle/Particle_Glow_04", pos = Vector(7.105, 0.968, -3.774), size = { x = 6.894, y = 6.894 }, color = Color(255, 80, 50, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = true}
}
...
function SWEP:Equip(NewOwner)	 self:FalsifyVars() return true end
function SWEP:OnDrop()			 self:FalsifyVars() return true end
function SWEP:OwnerChanged()	 self:FalsifyVars() return true end

function SWEP:Deploy()
	self:FalsifyVars()

	self.Weapon:SendWeaponAnim(ACT_VM_DRAW)
	if SERVER then self.NextIdle = CurTime() + self:SequenceDuration() end
...
function SWEP:OnRemove()
	self:FalsifyVars()
	self:Holster()
	if CLIENT and IsValid(self) and IsValid(self.Owner) and isfunction(self.RemoveModels) then self:RemoveModels() end
end
...
function SWEP:Reload()
	...
	if self.dt.NewAmmo < self.MaxAmmo then -- Goldeneye-style reload
		self:SetNextPrimaryFire(CurTime() + 2.1)
		self:SetNextSecondaryFire(CurTime() + 2.1)

		if SERVER then self.NextIdle = math.huge self.Owner:SetFOV(0, 0.25) end
		...
		for i=0,3 do
			timer.Simple(0.3 + (i * 0.367), function()
				...
				if !self.ReloadCheck then return end -- so you can't continue reloading if you switch weapons during
				if i == 0 then self.Owner:ViewPunch(Angle(0.6, -0.2, 0)) end
				if i != 3 then
					if SERVER then self.Weapon:EmitSound("weapons/357/357_reload"..1 + math.ceil(i * 1.5)..".wav", 70, 100) end
				else
					self.Weapon:SendWeaponAnim(ACT_VM_DRAW)
					if SERVER then
...
function SWEP:PrimaryAttack()
	...
	local BulletAcid = function(attacker, tr, dmginfo)
		...
		for i=0,1 do -- double sounds since they're pretty quiet otherwise
	...
	if self.dt.NewAmmo > 0 then -- effects and sound, if you have ammo
		...
		if SERVER then self.dt.NewAmmo = self.dt.NewAmmo - 1 end
	end

	self:FireBullets(bullet)

	self.Owner:ViewPunch(Angle(math.Rand(-1.8,-2.5), math.Rand(-1,1), 0))
	self.Weapon:EmitSound("Weapon_357.Single")
	self.Weapon:SendWeaponAnim(ACT_VM_PRIMARYATTACK)
	self.Owner:SetAnimation(PLAYER_ATTACK1)
	self.Owner:MuzzleFlash()

	if SERVER then self.NextIdle = CurTime() + (self:SequenceDuration() - 0.2) end
...
function SWEP:GetViewModelPosition(pos, ang)
	...
	if ( !bIron && fIronTime < CurTime() - 0.2 ) then 
		return pos, ang 
	end
