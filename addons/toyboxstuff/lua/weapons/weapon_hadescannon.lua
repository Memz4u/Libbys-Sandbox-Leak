-- "addons\\toyboxstuff\\lua\\weapons\\weapon_hadescannon.lua"
...
SWEP.VElements = {
	["some_unique_name3+"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "base", rel = "", pos = Vector(2.618, -0.306, 4.631), angle = Angle(0, -21.831, 90.88), size = Vector(0.5, 0.5, 0.5), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name4"] = { type = "Model", model = "models/props_combine/combine_fence01a.mdl", bone = "base", rel = "", pos = Vector(5.282, -3.145, 25.305), angle = Angle(-95, 0, 0), size = Vector(0.079, 0.079, 0.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name5"] = { type = "Sprite", sprite = "models/weapons/V_smg1/texture5", bone = "base", rel = "", pos = Vector(9.105, -0.625, 23.031), size = { x = 2, y = 2 }, color = Color(2550, 2550, 2550, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = false, ignorez = false},
	["some_unique_name2"] = { type = "Model", model = "models/props_lab/incubatorplug.mdl", bone = "base", rel = "", pos = Vector(4.169, -0.382, 22.555), angle = Angle(0, 180, 92.025), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name3++"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "base", rel = "", pos = Vector(2.618, -0.306, -1.507), angle = Angle(0, -21.831, 90.88), size = Vector(0.5, 0.5, 0.5), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name3"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "base", rel = "", pos = Vector(2.618, -0.306, 11.3), angle = Angle(0, -21.837, 90.88), size = Vector(0.5, 0.5, 0.5), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name"] = { type = "Model", model = "models/props_lab/LabTurret.mdl", bone = "base", rel = "", pos = Vector(-1.231, -8.263, 11.274), angle = Angle(0, 1.549, 88.212), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name4+"] = { type = "Model", model = "models/props_combine/combine_fence01a.mdl", bone = "base", rel = "", pos = Vector(5.282, 2.336, 25.305), angle = Angle(95, 180, 0), size = Vector(0.079, 0.079, 0.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["some_unique_name4+"] = { type = "Model", model = "models/props_combine/combine_fence01a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(17.049, 7.618, -7.369), angle = Angle(0, 0, 95), size = Vector(0.079, 0.079, 0.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name3+"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.65, 4.446, -7.488), angle = Angle(0, -88, -7.7), size = Vector(0.3, 0.3, 0.3), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name3"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.212, 4.489, -8), angle = Angle(0, -88, -7.7), size = Vector(0.3, 0.3, 0.3), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name4"] = { type = "Model", model = "models/props_combine/combine_fence01a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.062, 7.3, -11.877), angle = Angle(32.536, -180, -90.2), size = Vector(0.079, 0.079, 0.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name"] = { type = "Model", model = "models/props_lab/LabTurret.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.993, 0.787, -12.763), angle = Angle(0, -87.082, -6.151), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["some_unique_name3++"] = { type = "Model", model = "models/props_lab/labpart.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.487, 4.493, -8.337), angle = Angle(0, -88.056, -7.782), size = Vector(0.3, 0.3, 0.3), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["some_unique_name2"] = { type = "Model", model = "models/props_lab/incubatorplug.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.118, 6.212, -9.344), angle = Angle(0, 81.031, 9.355), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:ShootCannon()
	...
	self.Owner:EmitSound(self.Cannon.ShootSound, 85)
	...
	timer.Simple(delay, function() print("!?!") self:Disintegrate(tr) end)
	
	self.Charging = false
	self:DoCooldown()
end

function SWEP:Disintegrate(tr) -- main one
	if SERVER then
...
function SWEP:GetViewModelPosition( pos, ang )
	...
	if( self.dt.Phase == PHASE_COOLDOWN || self.dt.Phase == PHASE_NONE ) then
