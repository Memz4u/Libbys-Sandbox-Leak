-- "addons\\toyboxstuff\\lua\\weapons\\weapon_ninjastars.lua"
...
function SWEP:Reload()
	if self:GetNextReload() < CurTime() and self.Owner:KeyDown(IN_USE) and self.Owner:KeyDown(IN_SPEED) then
		self:SetWussMode(!self.WussMode)
