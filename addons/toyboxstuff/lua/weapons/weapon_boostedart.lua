-- "addons\\toyboxstuff\\lua\\weapons\\weapon_boostedart.lua"
...
function SWEP:SecondaryAttack()
	if(self.DoBoost == true) then
		self.DoBoost = false
		self.Owner:PrintMessage(HUD_PRINTCENTER,"BOOST IS OFF")
	elseif(self.DoBoost == false) then
		self.DoBoost = true
		self.Owner:PrintMessage(HUD_PRINTCENTER,"BOOST IS ON")
	end
end
function SWEP:Think()				
end
