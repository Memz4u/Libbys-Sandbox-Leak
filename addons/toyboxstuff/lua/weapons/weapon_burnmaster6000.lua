-- "addons\\toyboxstuff\\lua\\weapons\\weapon_burnmaster6000.lua"
...
SWEP.VElements = {
	["nozzlehose"] = { type = "Model", model = "models/props_c17/signpole001.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(1.843, -1.012, 3.312), angle = Angle(-179.032, 134.1, -179.907), size = Vector(0.337, 0.337, 0.337), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["chamber++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 17.669), angle = Angle(0, 9.394, 0), size = Vector(0.079, 0.079, 0.166), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["chamber++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x2.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, -1.938), angle = Angle(0, 9.394, 0), size = Vector(0.075, 0.075, 0.075), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["fuel_line_1+"] = { type = "Model", model = "models/props_c17/GasPipes006a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(-2.708, -3.3, 3.319), angle = Angle(-0.588, 90.224, 104.481), size = Vector(0.159, 0.159, 0.159), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["chamber+++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x2b.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, -1.938), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.085), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["chamber++++++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 11.899), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["stock2"] = { type = "Model", model = "models/props_c17/FurnitureDrawer003a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.393, -0.838, -8.912), angle = Angle(7.105, -88.431, 0), size = Vector(0.21, 0.266, 0.204), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["nozzle01+"] = { type = "Model", model = "models/props_wasteland/laundry_washer001a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.906, -2.951, 0.317), angle = Angle(-92.064, 23.018, -34.826), size = Vector(0.014, 0.014, 0.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["nozzle01"] = { type = "Model", model = "models/props_wasteland/laundry_washer001a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.906, -2.951, 2.312), angle = Angle(-92.064, 23.018, -34.826), size = Vector(0.014, 0.014, 0.014), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["stock"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.219, -0.844, -3.899), angle = Angle(0, 2.638, -25.194), size = Vector(0.136, 0.136, 0.048), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
	["chamber+++++++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 15.899), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["chamber+++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 5.663), angle = Angle(0, 9.394, 0), size = Vector(0.072, 0.072, 0.072), color = Color(255, 255, 255, 255), surpresslightning = true, material = "phoenix_storms/chrome", skin = 0, bodygroup = {[2] = 1} },
	["flamenozzle"] = { type = "Model", model = "models/props_vehicles/carparts_muffler01a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(2.687, -0.131, 44), angle = Angle(-83.506, -136.644, 19.643), size = Vector(0.156, 0.156, 0.156), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["flame"] = { type = "Sprite", sprite = "sprites/glow02", bone = "ValveBiped.Crossbow_base", rel = "flamenozzle", pos = Vector(-5.645, 0, 0), size = { x = 2.566, y = 6.216 }, color = Color(255, 60, 0, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["chamber++++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 3.9), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["tank"] = { type = "Model", model = "models/props_junk/gascan001a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(-2.664, -0.695, 5.425), angle = Angle(0, 180, 0), size = Vector(0.486, 0.486, 0.486), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["chamber++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x1.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, -2.589), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.039), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["endnozzle"] = { type = "Model", model = "models/xqm/afterburner1medium.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(-0.025, -1.624, 55), angle = Angle(0, -1.226, 0), size = Vector(0.085, 0.085, 0.229), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {} },
	["chamber+++++++++"] = { type = "Model", model = "models/hunter/tubes/tube1x1x4.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.187, -1.625, 7.9), angle = Angle(0, 9.394, 0), size = Vector(0.085, 0.085, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/props_pipes/pipesystem01a_skin2", skin = 0, bodygroup = {[2] = 1} },
	["radiator"] = { type = "Model", model = "models/props_wasteland/prison_heater001a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(1.906, -2.013, 3.805), angle = Angle(0, 0, 0), size = Vector(0.063, 0.063, 0.063), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["fuel_line_1"] = { type = "Model", model = "models/props_c17/GasPipes006a.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(-2.671, -3.3, 1.319), angle = Angle(-0.588, 90.224, 104.481), size = Vector(0.159, 0.159, 0.159), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["grip"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Crossbow_base", rel = "", pos = Vector(0.056, 0.105, -3.789), angle = Angle(0, 0, -0.131), size = Vector(0.143, 0.143, 0.234), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(-0.219, 0, 0), angle = Angle(0.361, -18.101, 0) },
	["ValveBiped.bowl_wheel"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.bowl1"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.bowl2"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.bowr2"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.bowr1"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.pull"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 1.549), angle = Angle(0, 0, 0) },
...
function SWEP:CanReload()
	if self.Owner:KeyDown(IN_ATTACK) or self.Owner:KeyDown(IN_ATTACK2) or self:Clip1() > 2499 or self:GetNWBool("Reloading") == true or (self:Clip1() == self:GetMaxClip1() and self:Clip2() == self:GetMaxClip2()) then return false end
	return true
end
...
function SWEP:CanPrimaryAttack()
	if self:GetNWBool("Reloading") == true or self:Clip1() < 1 then
		return false
	end
	return true
end
...
function SWEP:GetViewModelPosition( origin, angles )
	...
	if !isnumber(self.VMOffset) then self.VMOffset = 0 end
...
function SWEP:SecondaryAttack()
	...
	if not self:CanSecondaryAttack() or self.Owner:WaterLevel() > 1 or self:GetNWBool("Reloading") == true  then 
	self:StopSounds() 
	return end
	...
	if not self:CanSecondaryAttack() or self.Owner:WaterLevel() > 1 then 
	self:StopSounds() 
	return end
		...
		local normal = traceRes.HitNormal
			...
			if SERVER then
				for key,found in pairs(ents.FindInSphere(hitpos,32)) do
					...
					self:explode(self.Owner,PlayerPos) --Then blow ourselves up.
...
function burndamage(ptres)
	...
	if damage > 400 then damage = 400 end
