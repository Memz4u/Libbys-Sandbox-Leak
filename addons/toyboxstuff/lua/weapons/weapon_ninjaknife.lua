-- "addons\\toyboxstuff\\lua\\weapons\\weapon_ninjaknife.lua"
...
function SWEP:CloakThink()
	...
	if(!IsValid(VM) || !IsValid(hands)) then return end // Just wait a while - itll come back, eventually.
	if(self:GetCloaked() == true) then
		VM:SetMaterial("models/props_c17/fisheyelens")
		hands:SetMaterial("models/props_c17/fisheyelens")
