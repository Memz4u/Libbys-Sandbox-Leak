-- "addons\\odenough\\gamemodes\\sandbox\\gamemode\\player_class\\player_sandbox.lua"
...
function PLAYER:ShouldDrawLocal() 
	...
	if ( self.TauntCam:ShouldDrawLocalPlayer( self.Player, self.Player:IsPlayingTaunt() ) ) then return false end
